...
module.exports = app => {
  ...
  app.get("/Superadmin/Lespaysliste", admin.LesPaysSelect);
  //Modifier les Informations d un Pays
  app.post("/Superadmin/PaysModidifierinfo", admin.ModifierPaysInfo);
  //Ajout d un Pays
  app.post("/Superadmin/PaysAjoutInfo", admin.AjoutPaysInfo);
